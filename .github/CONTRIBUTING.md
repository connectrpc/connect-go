...
and run `git commit` with the `-s` flag to sign off. If necessary, a bot will remind
you to sign off on your commits when you open your pull request, and provide helpful
tips.
