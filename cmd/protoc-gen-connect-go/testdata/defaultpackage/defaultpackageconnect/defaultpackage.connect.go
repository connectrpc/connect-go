...
package defaultpackageconnect

import (
	connect "connectrpc.com/connect"
	defaultpackage "connectrpc.com/connect/cmd/protoc-gen-connect-go/testdata/defaultpackage"
	context "context"
	errors "errors"
	http "net/http"
	strings "strings"
...
type TestServiceClient interface {
	Method(context.Context, *connect.Request[defaultpackage.Request]) (*connect.Response[defaultpackage.Response], error)
}
...
func NewTestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TestServiceClient {
	...
	testServiceMethods := defaultpackage.File_defaultpackage_proto.Services().ByName("TestService").Methods()
	return &testServiceClient{
		method: connect.NewClient[defaultpackage.Request, defaultpackage.Response](
			httpClient,
...
type testServiceClient struct {
	method *connect.Client[defaultpackage.Request, defaultpackage.Response]
}

// Method calls connect.test.default_package.TestService.Method.
func (c *testServiceClient) Method(ctx context.Context, req *connect.Request[defaultpackage.Request]) (*connect.Response[defaultpackage.Response], error) {
...
func (UnimplementedTestServiceHandler) Method(context.Context, *connect.Request[defaultpackage.Request]) (*connect.Response[defaultpackage.Response], error) {
