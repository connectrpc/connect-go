...
func WithCodec(name string, c Codec) Option {
	return &codecOption{
		Name:  name,
		Codec: c,
	}
...
// WithProtobuf registers a binary protocol buffer codec that uses
// google.golang.org/protobuf/proto.
//
// Handlers and clients generated by protoc-gen-go-connect have WithProtobuf
// applied by default. To replace the default binary protobuf codec (with
// vtprotobuf, for example), make sure to use the name "protobuf" rather than
// "proto".
func WithProtobuf() Option {
	return WithCodec(codecNameProtobuf, &codecProtobufBinary{})
}

// WithProtobufJSON registers a codec that serializes protocol buffer messages
// as JSON. It uses the standard protobuf JSON mapping as implemented by
...
//
// Handlers generated by protoc-gen-go-connect have WithProtobufJSON applied by
// default.
func WithProtobufJSON() Option {
	return WithCodec(codecNameJSON, &codecProtobufJSON{})
}
